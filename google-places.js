        ...
        var renderReviews = function(reviews){
          ...
          for (var i = row_count; i >= 0; i--) {
            ...
            $.getJSON(url_to_img_field, function (json) {
                ...
                url_image = json_response.image.url; //JSON response: image { url {}}
            }); 
            html = html+"<div class='review-item'><div class='review-meta'><span class='review-author-image'><img src="+json_response.image.url+"/></span><span class='review-author'>"+reviews[i].author_name+"</span><span class='review-sep'>, </span><span class='review-date'>"+date+"</span></div>"+stars+"<p class='review-text'>"+reviews[i].text+"</p></div>";
          };
          $element.append(html);
        }
