...
urlpatterns = [
    ...
    url(r'^partidos/(?P<id_partido>[-\w]+)/$', views.detailPartido, name='detalle_partido'),
    ...
    url(r'^partidos/(?P<id_partido>[-\w]+)/numero-militantes/$', views.cuentaMilitantes, name='numero_militantes'),
